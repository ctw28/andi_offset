...
if($row['status']=='Menikah'){
    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'Nama Pasangan',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['nama_pasangan'],0,0);
    
    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'Pekerjaan',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['pekerjaan'],0,0);
    
    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'TTL Pasangan',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['tempat_lahir_status'].', '.tgl_indo($row['tgl_lahir_status']),0,0);
        
    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'No. Telp Pasangan',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['no_handphone_status'],0,0);
    
    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'Jumlah Anaka',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['jml_anak'],0,0);
...
$pdf->SetFont('Arial','',9);
    ...
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'Tidak Ada Pengalaman Kerja',0,0);
}
$pdf->SetFont('Arial','B',9);
...
if($row['punya_ayah_tiri']=='Ada'){
    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(10,6,'',0,0);
    $pdf->Cell(40,6,'Nama Ayah Tiri',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['nama_ayah_tiri'],0,0);

    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(10,6,'',0,0);
    $pdf->Cell(40,6,'Usia Ayah Tiri',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['usia_ayah_tiri'],0,0);

    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(10,6,'',0,0);
    $pdf->Cell(40,6,'Pekerjaan Ayah Tiri',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['pekerjaan_ayah_tiri'],0,0);

    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(10,6,'',0,0);
    $pdf->Cell(40,6,'No. Hp Ayah Tiri',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['no_handphone_ayah_tiri'],0,0);

}

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Nama  ibu',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['nama_ibu'],0,0);
$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Usia',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['usia_ibu'],0,0);

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Pekerjaan',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['pekerjaan_ibu'],0,0);

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'No. Telp',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['no_handphone_ibu'],0,0);

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Status Hidup',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['status_ibu'],0,0);

if($row['punya_ibu_tiri']=='Ada'){
    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'Nama Ibu Tiri',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['nama_ibu_tiri'],0,0);

    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'Usia Ibu Tiri',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['usia_ibu_tiri'],0,0);

    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'Pekerjaan Ibu Tiri',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row[' pekerjaan_ibu_tiri '],0,0);

    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'No. Hp Ibu Tiri',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row[' no_handphone_ibu_tiri '],0,0);
...
$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Gaji',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,rupiah($row['gaji']),0,0);

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Kekurangan',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['kekurangan'],0,0);

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Kelebihan',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['kelebihan'],0,0);

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Bisa Kendaraan',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['bisa_kendaraan'],0,0);

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Punya Sim',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['punya_sim'],0,0);

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Info Lowongan',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['info_lowongan'],0,0);

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Kenalan',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['kenalan'],0,0);

if($row['pekerjaan_sampingan']=='Ada'){

    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'Nama Usaha',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['nama_usaha'],0,0);

    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'Tahun Mulai',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['tahun_mulai'],0,0);

    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'Posisi Sampingan',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['posisi_sampingan'],0,0);

    $pdf->Cell(10,5,'',0,1);
    $pdf->Cell(4,6,'',0,0);
    $pdf->Cell(40,6,'Bidang Sampingan',0,0);
    $pdf->Cell(5,6,': ',0,0);
    $pdf->Cell(30,6,$row['bidang_sampingan'],0,0);    
}


$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Terlibat Kejahatan',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['terlibat_kejahatan'],0,0);

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Kebiasaan Disukai',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['kebiasaan_disukai'],0,0);

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Mulai Kerja',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['mulai_kerja'],0,0);

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Keperluan Mendesak',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['keperluan_mendesak'],0,0);

$pdf->Cell(10,5,'',0,1);
$pdf->Cell(4,6,'',0,0);
$pdf->Cell(40,6,'Moody',0,0);
$pdf->Cell(5,6,': ',0,0);
$pdf->Cell(30,6,$row['moody'],0,0);
