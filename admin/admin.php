...
<body>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h2>Detail</h2>
                                        <table class="detail">
                                            <h4 style="text-align: left;" id="pribadi">Data Pribadi</h4>
                                            <tr>
                                                <td width="40%">Nama</td>
                                                <td width="10%"> : </td>
                                                <td id="tampilNama"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="10%"> : </td>
                                                <td id="tampilJenisKelamin"></td>
                                            </tr>
                                            <tr>
                                                <td width="40%">Alamat KTP</td>
                                                <td width="10%"> : </td>
                                                <td id="tampilAlamatKTP"></td>
                                            </tr>
                                            <tr>
                                                <td width="40%">No. Handphone</td>
                                                <td width="10%"> : </td>
                                                <td id="tampilNoHandphone"></td>
                                            </tr>
                                            <tr>
                                                <td width="40%">Email</td>
                                                <td width="10%"> : </td>
                                                <td id="tampilEmail"></td>
                                            </tr>
                                        </table>
                                        <table class="detail">                                        
                                            <h4 style="text-align: left; margin-top: 20px;" id="lamaran">Data Lamaran</h4>
                                            <tr>
                                                <td width="40%">Posisi 1</td>
                                                <td width="10%"> : </td>
                                                <td id="tampilPosisi1"></td>
                                            </tr>
                                            <tr>
                                                <td width="40%">Posisi 2</td>
                                                <td width="10%"> : </td>
                                                <td id="tampilPosisi2"></td>
                                            </tr>
                                            <tr>
                                                <td width="40%">Penempatan</td>
                                                <td width="10%"> : </td>
                                                <td id="tampilPenempatan"></td>
                                            </tr>
                                            <tr>
                                                <td width="40%">Gaji</td>
                                                <td width="10%"> : </td>
    ...
    $(document).ready(function(){
        $('.tombol_detail').on('click', function(){
            ...
            console.log(btn);
            $.ajax({
                url: "http://localhost/andi/detail.php?id="+btn,
                type: "GET",
                dataType: 'json',
                success: function(data){
                    console.log(data.nama_pelamar);
                    $("#tampilNama").text(data.nama_pelamar);
