                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="http://localhost/andi_offset/admin/">Dashboard <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                          
                                        </li>
                                        <li><a data-toggle="collapse" data-target="#demo" href="http://localhost/andi_offset/admin/data-pelamar.php">Daftar Pelamar <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
