<?php 
	...
	$suratKeteranganKerja 	= validateFileUpload('inputSuratKeteranganKerja','SURAT KETERANGAN KERJA');
	$ijazah 	 			= validateFileUpload('inputIjazah', 'IJAZAH');
	$transkrip	 			= validateFileUpload('inputTranskrip', 'TRANSKRIP');
	$uploadSim				= validateFileUpload('inputUploadSim', 'SIM');
	$uploadSKCK				= validateFileUpload('inputUploadSKCK', 'SKCK');		
	...
	$tempatLahir 		= stripCleanToHTML($_POST['inputTempatLahir']);
	$tanggalLahir 		= stripCleanToHTML($_POST['inputTanggalLahir']);
	$jenisKelamin 		= stripCleanToHTML($_POST['inputJenisKelamin']);
	$alamatKTP 			= cleanToHTML($_POST['inputAlamatKTP']);
	$alamatDomisili 	= cleanToHTML($_POST['inputAlamatDomisili']);
	$noTelp 			= stripCleanToHTML($_POST['inputNoTelp']);
	$email 				= filter_var(stripCleanToHTML($_POST['inputEmail']), FILTER_SANITIZE_EMAIL);
